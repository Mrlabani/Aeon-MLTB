...
async def get_readable_message(sid, is_user, page_no=1, status="All", page_step=1):
    msg = ""
    msg += "<blockquote><b>Powered by @l_abani</b></blockquote>\n\n"
    button = None
    ...
    msg += "\n\n<blockquote><b>Support the group by completing the link <a href='https://t.me/noob_project'>here</a></b></blockquote>"
    return msg, button
